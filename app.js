...
function build(p) {
  ...
  return shell(p,
    ...
    <div class="card"><div class="section-title">Your 15-second company pitch</div><p class="big-output">${esc(companyPitch(p))}</p><button class="btn copy-pitch">Copy pitch</button></div>
